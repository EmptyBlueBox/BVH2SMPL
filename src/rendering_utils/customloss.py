...
def body_fitting_loss_3d(body_pose, preserve_pose,
    ...
    # print('joint3d_loss', torch.mean(joint3d_loss))
    # print('pose_prior_loss', torch.mean(pose_prior_loss))
    # print('angle_prior_loss', torch.mean(angle_prior_loss))
    # print('shape_prior_loss', torch.mean(shape_prior_loss))
    # print('collision_loss', collision_loss)
    # print('pose_preserve_loss', torch.mean(pose_preserve_loss))
