...
import os
import torch
import rendering_utils.config as config
import smplx
import h5py
from rendering_utils.smplify import SMPLify3D
...
class joints2smpl:
    ...
    def __init__(self, num_frames, device_id, cuda=True):
        ...
        # self.num_joints = 24  # for HumanML3D
        self.joint_category = "AMASS"
        # self.joint_category = "orig"
        self.num_smplify_iters = 500
        # self.fix_foot = False
        self.fix_foot = True
    ...
    def joint2smpl(self, input_joints, init_params=None):
        ...
        if self.joint_category == "AMASS":
            ...
            if self.fix_foot == True:
                ...
                confidence_input[8] = 1.5 # ankle
                confidence_input[10] = 1.5
                confidence_input[11] = 1.5 # foot
                confidence_input[15] = 1.5 # head!!!!!!!!!!!!!!!!
                confidence_input[20] = 1.5 # wrist!!!!!!!!!!!!!!!!
                confidence_input[21] = 1.5 # wrist!!!!!!!!!!!!!!!!
        else:
            confidence_input = torch.ones(self.num_joints)
            # make sure the foot and ankle
            if self.fix_foot == True:
                ...
                confidence_input[11] = 1.5 # foot
                confidence_input[15] = 1.5 # head!!!!!!!!!!!!!!!!
                confidence_input[22] = 1.5 # hand!!!!!!!!!!!!!!!!
                confidence_input[23] = 1.5 # hand!!!!!!!!!!!!!!!!
